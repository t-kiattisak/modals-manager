...
import { handleCloseModal, modalsReducer } from "./reducers/modals.reducer"
import { randomId } from "./utility/randomId.utility"
import { useModalsEvents } from "./utility/events.utility"
...
export function ModalsProvider({
  ...
  const updateModal = useCallback(
    ({
      modalId,
      ...newProps
    }: Partial<ModalSettings> & { modalId: string }) => {
      dispatch({
        type: "UPDATE",
        modalId,
        newProps,
